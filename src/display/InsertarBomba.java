...
public class InsertarBomba extends PageController {
    ...
    /**
     * Utilizado como controlador de página para la acción de insertar bombas.
     * @param request
     * @param response
    ...
    try {
	  ...
	  module.agregar(marca,modelo,capacidad,fechaInstalacion,fechaUltimoMantenimiento,estado,idPozo);
