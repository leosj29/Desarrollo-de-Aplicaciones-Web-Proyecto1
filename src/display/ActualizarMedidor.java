...
public class ActualizarMedidor extends PageController {
    ...
    /**
     * Utilizado como controlador de página para la acción de actualizar un medidor.
     * @param request
     * @param response
    ...
    try {
      ...
      module.actualizar(idMedidor, material, marca, tipo, diametro, presionTrabajo, fechaInstalacion, fechaUltimaInspeccion, estado);
