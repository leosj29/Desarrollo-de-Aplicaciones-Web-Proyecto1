...
public class InsertarValvula extends PageController {
    ...
    /**
     * Utilizado como controlador de página para la acción de insertar válvula.
     * @param request
     * @param response
    ...
    try {
	  ...
	  module.agregar(marca, diametro, tipo, numeroSerie, presionMaxima, fechaInstalacion, fechaUltimaInspeccion,estado);
